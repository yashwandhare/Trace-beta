...
data class Model(
   ...
   *
   * The <app_id> is `com.trace.app` for every build (namespace and applicationId are unified).
   *
   * For example, if this field is set to "my_model/local_dir/", then the location you should push
   * files to is:
   *
   * /storage/emulated/0/Android/data/com.trace.app/files/my_model/local_dir/
   *
