...
// import com.trace.app.ui.preview.PreviewChatModel
// import com.trace.app.ui.preview.PreviewModelManagerViewModel
// import com.trace.app.ui.preview.TASK_TEST1
...
import com.trace.app.ui.common.copyBitmapToClipboard
import com.trace.app.ui.common.saveBitmapToMediaStore
import com.trace.app.ui.common.shareBitmap
...
/**
 * Deserializes a list of [com.trace.app.proto.ChatMessageProto] from persistent
...
private fun deserializeProtoMessages(
  protoMessages: List<com.trace.app.proto.ChatMessageProto>
): List<ChatMessage> {
  return protoMessages.mapNotNull { protoMsg ->
    val side =
      when (protoMsg.side) {
        com.trace.app.proto.ChatSideProto.CHAT_SIDE_USER -> ChatSide.USER
        com.trace.app.proto.ChatSideProto.CHAT_SIDE_MODEL -> ChatSide.AGENT
        com.trace.app.proto.ChatSideProto.CHAT_SIDE_SYSTEM -> ChatSide.SYSTEM
